...
root_pathp = FileSystemPathPointer('.')
nomfile_pathp = FileSystemPathPointer('datasets/nombank.1.0/sorted_nombank.1.0')
framefiles = '.*\.xml'
words_pathp = FileSystemPathPointer('datasets/nombank.1.0/nombank.1.0.words')
...
def main():
    data = 'datasets/ALGNLP_2/data'
    instances = reader.instances()

    train_filepath = 'datasets/preprocessed/train.srl'
    devel_filepath = 'datasets/preprocessed/development.srl'
    test_filepath = 'datasets/preprocessed/test.srl'
